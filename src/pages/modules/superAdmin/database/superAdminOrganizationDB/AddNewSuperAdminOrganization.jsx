...
const AddNewSuperAdminOrganization = ({ mode = "add" }) => {
  ...
  console.log("adminOrganizationalDBByID", adminOrganizationalDBByID)
  ...
  const tabKeysMapping = {
    "Basic Info": [
      "Basic.segment",
      "Basic.hospitalName",
      "Basic.typeOfHospital",
      "Basic.typeOfOrgOrHospital",
      "Basic.ifGovt",
      "Basic.address",
      "Basic.district",
      "Basic.state",
    ...
    "Hospital Data": [
      ...
      "hospitalData.totalICUBeds",
      "hospitalData.totalOT",
    ],
    ...
    Kitchen: [
      "kitchenWasteManagement.KWMQ1",
      "kitchenWasteManagement.KWMQ2",
      "kitchenWasteManagement.KWMQ3",
      "kitchenWasteManagement.KWMQ4",
      "kitchenWasteManagement.KWMQ5",
      "kitchenWasteManagement.KWMQ6",
      "kitchenWasteManagement.KWMQ7",
      "kitchenWasteManagement.KWMQ8",
      "kitchenWasteManagement.KWMQ9",
      "kitchenWasteManagement.KWMQ10",
      "kitchenWasteManagement.KWMQ11",
    ],
    "Physiotherapy Setup": [
      "physiotherapy.primaryObjective",
      "physiotherapy.intendedFor",
      "physiotherapy.setupContext",
      "physiotherapy.expectedPatientLoad",
      "physiotherapy.serviceType",
      "physiotherapy.plannedLocation",
      "physiotherapy.totalArea",
      "physiotherapy.areaDivision",
      "physiotherapy.patientMovementFlow",
      "physiotherapy.barrierFreeAccessibility",
      "physiotherapy.infrastructurePlanned",
      "physiotherapy.ventilationLighting",
      "physiotherapy.suitableFlooring",
      "physiotherapy.privacyRequirements",
      "physiotherapy.essentialEquipment",
      "physiotherapy.advancedTechnologies",
      "physiotherapy.treatmentStations",
      "physiotherapy.equipmentPreference",
      "physiotherapy.powerRequirements",
      "physiotherapy.physiotherapistCount",
    ],
    "Waste Management": [
      "wasteManagement.types",
      "bioMedicalWaste",
      "solidWaste",
