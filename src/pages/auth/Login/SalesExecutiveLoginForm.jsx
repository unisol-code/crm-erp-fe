...
const SalesExecutiveLoginForm = ({ loading, onSubmit, initialValues }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="w-full m-auto">
      ...
      <div className="flex justify-center w-full py-4 text-center">
        <button
          type="submit"
          className="text-[16px] flex justify-center items-center text-center font-bold bg-[#E5C1A9] h-[40px] rounded-full hover:bg-[#dcad8b] hover:shadow-md w-[120px] disabled:bg-[#D3D3D3]"
          disabled={loading}
        >
          {loading ? (
...
export default SalesExecutiveLoginForm;